    ...
    <div class="ss-grid sr d1">
      ...
      foreach ( [
          ...
          [ 'icon' => '<polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>',
            'title' => 'السيو التقني', 'desc' => 'إصلاح الأخطاء التقنية التي تمنع جوجل من فهرسة موقعك وترتيبه بشكل صحيح.',
            'url' => sh_page_url( 'services/seo/technical' ),
            'items' => [ 'تحليل قابلية الزحف والفهرسة', 'سرعة التحميل وCore Web Vitals', 'البيانات المنظمة والـSchema', 'إصلاح الأخطاء التقنية بالتسلسل الصحيح' ] ],
          [ 'icon' => '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/>',
            'title' => 'السيو الداخلي', 'desc' => 'تهيئة كل صفحة بمنهجية مدروسة لترتيبها على الكلمة المستهدفة بدقة.',
            'url' => sh_page_url( 'services/seo/on-page' ),
            'items' => [ 'تحسين العناوين والأوصاف والـH1', 'بنية روابط داخلية تدعم الفهرسة', 'تحسين المحتوى لنية البحث', 'تحليل صفحات المنافسين والفجوات' ] ],
      ] as $ss ) :
      ?>
      <div class="ss-card">
        <div class="ss-head">

...
$country_config = [
    ...
    'egypt' => [
        ...
        'hero_desc'    => 'مصر سوق رقمي في طور النضج — استخدام الإنترنت يتوسع بمرور الوقت. من يستثمر في السيو اليوم يبني حضوراً عضوياً يصعب اللحاق به لاحقاً.',
        'intro_tag'    => 'السوق المصري',
        'intro_title'  => 'لماذا السيو في مصر مختلف؟',
        'intro_desc'   => 'مصر سوق متنوع وقاعدة الإنترنت فيه في نمو — ومستوى التنافس يتفاوت بحسب القطاع والكلمات المستهدفة. تحليل البحث والمنافسة في مرحلة التدقيق يُحدد أين توجد الفرص الفعلية لموقعك تحديداً.',
        'points'       => [
            [ 'label' => 'قاعدة مستخدمين في نمو',      'desc' => 'قاعدة مستخدمي الإنترنت في مصر في نمو — والبحث يتم بالفصحى وباللهجة المصرية بحسب القطاع والجمهور' ],
            [ 'label' => 'فرص في قطاعات متعددة',         'desc' => 'التحليل الأولي يكشف القطاعات والكلمات التي يمكن المنافسة بها بصورة فعلية' ],
            [ 'label' => 'تجارة إلكترونية في نمو',      'desc' => 'قطاع التجارة الإلكترونية يتوسع في مصر — السيو أداة لبناء حضور مستدام في نتائج البحث' ],
        ...
        'scope_items'  => [
            ...
            [ 'n' => '09', 'label' => 'السيو المحلي وخرائط جوجل', 'desc' => 'تحسين الظهور المحلي للمواقع التجارية المؤهلة — ملف جوجل بيزنس وصفحات المدن والإشارات المحلية بحسب طبيعة النشاط والموقع' ],
        ],
        ...
        'process_steps' => [
            ...
            [ 'n' => '05', 'title' => 'القياس والتطوير المستمر',         'desc' => 'نُتابع الأداء بانتظام ونُعدّل الاستراتيجية بناءً على البيانات — الهدف نمو عضوي مستدام لا نتائج مؤقتة.' ],
        ],
        'process_note'  => 'ترتيب الخطوات يعتمد على وضع الموقع ونطاق العمل. الشهر الأول عادةً: تدقيق وتتبع وخارطة كلمات وأولويات تقنية. الشهر الثاني: تنفيذ التحسينات وتحديث الصفحات الأساسية والمحتوى والربط الداخلي. الشهر الثالث: توسيع المحتوى وبناء السلطة ومراجعة التحويلات. الوتيرة تختلف بحسب وضع الموقع والمنافسة وسرعة التنفيذ.',
        ...
        'faqs'         => [
            ...
            [ 'question' => 'متى أبدأ برؤية نتائج في السوق المصري؟',        'answer' => 'المؤشرات الأولية في حركة البحث وترتيب الكلمات تظهر مع استمرار التحسينات. التأثير على العملاء المحتملين يتراكم بمرور الوقت بحسب وضع الموقع والمنافسة والمحتوى المنفَّذ. المواقع التي تبدأ بأسس تقنية سليمة تصل للنتائج أسرع — التدقيق الأولي يكشف إذا كانت ثمة عوائق تُبطئ الأمور حتى قبل البدء بالاستراتيجية.' ],
            ...
            [ 'question' => 'هل السيو أجدى من الإعلانات المدفوعة في مصر؟', 'answer' => 'ليسا بديلَين — لكنهما بمنطق مختلف. الإعلانات تُولّد ترافيكاً فورياً ينتهي بانتهاء الميزانية. السيو يبني ترافيكاً متراكماً مستداماً. الشركات الذكية تُشغّل الاثنين: الإعلانات للمدى القصير والسيو استثمار طويل على المدى البعيد لمن يصبر عليه.' ],
            [ 'question' => 'ما الذي يشمله التقرير الشهري؟',               'answer' => 'البيانات متاحة في لوحة Looker Studio حية متصلة بـSearch Console وGoogle Analytics. تشمل: ترتيب الكلمات المستهدفة وتطوره، بيانات الظهور والنقرات والصفحات العضوية، ملخص العمل المُنجز، والخطة المقترحة للشهر التالي. يمكن إضافة تتبع التحويلات عند توافر إعداد موثوق ومُختبَر.' ],
        ],
    ...
    'saudi-arabia' => [
        ...
        'hero_desc'    => 'السوق السعودي يجمع بين انتشار رقمي واسع وتوجه متزايد نحو التجارة الإلكترونية والخدمات الرقمية — كل عميل محتمل من البحث العضوي هنا يستحق الاستثمار الحقيقي.',
        ...
        'points'       => [
            [ 'label' => 'انتشار رقمي واسع',              'desc' => 'انتشار استخدام الإنترنت والهواتف الذكية في السعودية مرتفع — مما يُوجد قاعدة بحث رقمي واسعة' ],
            [ 'label' => 'رؤية 2030 والتحول الرقمي',      'desc' => 'قطاعات جديدة تتشكل رقمياً — من يتصدر نتائج البحث اليوم يحتل مكانة يصعب إزاحتها' ],
            [ 'label' => 'فرصة في التوقيت',                'desc' => 'التحرك المبكر في بناء الحضور العضوي يُتيح تراكم سلطة الموقع قبل أن تتشكل المنافسة في قطاعك' ],
            [ 'label' => 'البحث بالعربية والإنجليزية',     'desc' => 'البحث بالعربية هو الأساس في معظم القطاعات — مع حضور الإنجليزية في بعض القطاعات الدولية' ],
        ],
        'why_tag'      => 'استراتيجية محلية',
        ...
        'why_items'    => [
            ...
            [ 'label' => 'سيو متاجر سلة وزد',               'desc' => 'إلمام تقني بمتطلبات منصات التجارة الإلكترونية المستخدمة في السوق السعودي وكيفية تحسين أداء كل منها' ],
            ...
            [ 'label' => 'استراتيجية على مستوى المنطقة',    'desc' => 'كثافة المنافسة والكلمات تتفاوت بين المناطق — التحليل يُحدد أولويات الاستهداف الجغرافي لكل موقع' ],
        ],
        'scope_tag'    => 'نطاق الخدمة',
        ...
        'scope_items'  => [
            ...
            [ 'n' => '09', 'label' => 'السيو المحلي وخرائط جوجل',           'desc' => 'تحسين الظهور المحلي للمواقع التجارية المؤهلة — ملف جوجل بيزنس وصفحات المدن وإشارات الحضور المحلي بحسب طبيعة النشاط' ],
        ],
        'process_tag'   => 'منهجية العمل',
        ...
        'process_steps' => [
            ...
            [ 'n' => '05', 'title' => 'القياس والتطوير والاستدامة',          'desc' => 'نُراجع الأداء شهرياً ونُحدّث الاستراتيجية بحسب تحديثات جوجل والمتغيرات التنافسية — الهدف نمو عضوي مستدام لا قفزات مؤقتة.' ],
        ],
        'process_note'  => 'ترتيب الخطوات يعتمد على وضع الموقع ونطاق العمل. الشهر الأول عادةً: تدقيق وتتبع وخارطة كلمات وأولويات تقنية. الشهر الثاني: تنفيذ التحسينات وتحديث الصفحات الأساسية والمحتوى والربط الداخلي. الشهر الثالث: توسيع المحتوى وبناء السلطة ومراجعة التحويلات. الوتيرة تختلف بحسب وضع الموقع والمنافسة وسرعة التنفيذ.',
        'report_tag'   => 'الشفافية والقياس',
        'report_title' => 'تقارير أداء البحث العضوي',
        ...
        'faqs'         => [
            ...
            [ 'question' => 'هل تشمل الخدمة السيو المحلي لمدن مثل الرياض وجدة والدمام؟', 'answer' => 'نعم. السيو المحلي يشمل تحسين ملف جوجل بيزنس وصفحات الخدمة الموجّهة جغرافياً وإشارات الحضور المحلي — مما يُحسّن الظهور في نتائج الخرائط والبحث المحلي في مدن المملكة.' ],
            [ 'question' => 'كم يستغرق السيو قبل ظهور نتائج في السعودية؟',    'answer' => 'الجدول الزمني يتفاوت بحسب وضع الموقع والمنافسة وسرعة التنفيذ. المؤشرات الأولية في ترتيب الكلمات وحركة البحث تظهر مع استمرار التحسينات، والتأثير على العملاء المحتملين يتراكم بمرور الوقت. التدقيق الأولي يُوضّح الوضع الراهن ويُساعد في وضع توقعات أكثر دقة.' ],
    ...
    'uae' => [
        ...
        'hero_desc'    => 'الإمارات سوق ثنائي اللغة يجمع جمهوراً عربياً ودولياً يبحث في نفس الوقت — كل منهما يحتاج استراتيجية سيو مختلفة.',
        ...
        'points'       => [
            ...
            [ 'label' => 'منافسة في الفضاء الرقمي',        'desc' => 'الإمارات تستقطب مواقع محلية ودولية تستهدف نفس الجمهور — بناء الحضور العضوي يُحسّن ظهور موقعك في نتائج البحث' ],
            [ 'label' => 'تنوع القطاعات',                   'desc' => 'تحليل الكلمات والمنافسة يُحدد القطاعات وأنواع الصفحات الأنسب للاستهداف لكل موقع' ],
            [ 'label' => 'جمهور رقمي نشط',                  'desc' => 'انتشار استخدام الإنترنت والهواتف الذكية في الإمارات مرتفع — مما يُوجد قاعدة بحث رقمي متنوعة' ],
        ],
        'why_tag'      => 'استراتيجية محلية',
        ...
        'scope_desc'   => 'التحدي الأكبر في الإمارات هو إدارة المعادلة الثنائية — سيو عربي قوي لجمهورك المحلي، وسيو إنجليزي لا يقل جودةً للجمهور الدولي، مع بنية تقنية تمنع التعارض بين الصفحتين في خوارزميات جوجل.',
        'scope_items'  => [
            ...
            [ 'n' => '06', 'label' => 'سيو العقارات والسياحة',           'desc' => 'تحسين متخصص لمواقع العقارات والسياحة والضيافة — يُعدّ نطاق العمل بحسب طبيعة الموقع وبيانات البحث في هذه القطاعات' ],
        ...
        'faqs'         => [
            ...
            [ 'question' => 'هل تشمل الخدمة السيو المحلي لمدن دبي وأبوظبي والشارقة؟', 'answer' => 'نعم. السيو المحلي يشمل تحسين ملف جوجل بيزنس للمواقع التجارية المؤهلة وصفحات الخدمة الموجّهة جغرافياً وإشارات الحضور المحلي — بحسب طبيعة النشاط والمدن المستهدفة.' ],
            ...
            [ 'question' => 'متى نرى نتائج ملموسة في السوق الإماراتي؟',      'answer' => 'الجدول الزمني يتفاوت بحسب وضع الموقع والمنافسة وسرعة التنفيذ. المؤشرات الأولية في ترتيب الكلمات وحركة البحث تظهر مع استمرار التحسينات، والتأثير على العملاء المحتملين يتراكم بمرور الوقت. الشفافية في التوقعات أساسية — نضع معك مؤشرات مرحلية واضحة من البداية حتى تعرف أين تسير الأمور.' ],
            [ 'question' => 'هل يمكنني تتبع أداء السيو عبر بيانات موثوقة؟',  'answer' => 'نربط Search Console وGoogle Analytics لقياس بيانات الظهور والنقرات والصفحات العضوية. يمكن إضافة تتبع التحويلات عند توافر إعداد موثوق ومُختبَر — مما يُتيح ربط أداء البحث بالإجراءات الفعلية على الموقع.' ],
        ],
...
$report_checklist = [
    'لوحة Looker Studio حية — متاحة في أي وقت، مُحدَّثة من Search Console وGoogle Analytics',
    'ترتيب الكلمات المستهدفة وتطوره مقارنةً بالشهر السابق',
    'حركة البحث العضوي وتطورها — من Search Console وGoogle Analytics',
...
$trust_items = [
    'تواصل شهري مع مدير حساب متخصص — لا تمرير لجهة ثالثة',
        ...
        <div style="background:var(--navy-2);border-radius:var(--r4);padding:32px 28px;position:relative;overflow:hidden">
          ...
          <div style="position:relative;z-index:1;display:flex;flex-direction:column;gap:11px">
            ...
            foreach ( [
                ...
                'تقرير Looker Studio حي يربط السيو بمؤشرات عملك',
            ] as $svc ) :
            ?>

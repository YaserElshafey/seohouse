...
$country_config = [
    ...
    'saudi-arabia' => [
        ...
        'why_items'    => [
            ...
            [ 'label' => 'سيو متاجر سلة وزد',               'desc' => 'إلمام تقني بمتطلبات المنصتين الأكثر انتشاراً في السوق السعودي وكيفية تحسين أداء كل منهما' ],
    ...
    'uae' => [
        ...
        'faqs'         => [
            ...
            [ 'question' => 'ما القطاعات التي تعملون بها في الإمارات؟',      'answer' => 'لدينا خبرة في العقارات والسياحة والضيافة والتجارة الإلكترونية والتعليم والتقنية في الإمارات — وهي القطاعات الأكثر نشاطاً في نتائج جوجل في هذا السوق. كل قطاع يتطلب مقاربة مختلفة — العقارات تحتاج صفحات محلية وسيو خرائط، السياحة تحتاج محتوى معلوماتياً غنياً، والتجارة الإلكترونية تحتاج تحسين بنية الكتالوج وصفحات المنتجات.' ],

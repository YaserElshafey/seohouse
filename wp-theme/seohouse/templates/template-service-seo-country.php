...
$country_config = [
    ...
    'egypt' => [
        ...
        'why_items'    => [
            ...
            [ 'label' => 'تقارير مرتبطة بأهداف عملك',       'desc' => 'بيانات البحث العضوي والصفحات — مع إمكانية ربط التحويلات عند توافر إعداد تتبع موثوق' ],
        ...
        'scope_desc'   => 'كل خدمة في هذه القائمة مُصمَّمة للعمل في السياق المصري — الكلمات التي يستخدمها جمهورك، المنافسون الذين يجب فهمهم، والمحتوى الذي يُخاطب المستخدم المصري. التسلسل من الأساسيات إلى الروابط ليس عشوائياً — هو الترتيب الذي تُبنى عليه تحسينات فعلية قابلة للقياس.',
        'scope_items'  => [
            ...
            [ 'n' => '09', 'label' => 'السيو المحلي وخرائط جوجل', 'desc' => 'للمواقع التجارية ذات عنوان موثق قد يشمل العمل: تحسين الملف التجاري على Google لمدن كالقاهرة والجيزة والإسكندرية، واتساق معلومات النشاط والمراجعات، وإشارات الفروع أو نطاق الخدمة. صفحات المدن تُنشأ فقط عند وجود قيمة محلية فعلية.' ],
        ],
        ...
        'process_steps' => [
            ...
            [ 'n' => '04', 'title' => 'المحتوى وبناء السلطة',            'desc' => 'نُنشئ محتوى يستهدف الكلمات ذات الأولوية ونبني روابط خارجية تُعزز سلطة الموقع — عمل متراكم شهر بعد شهر.' ],
        ...
        'faqs'         => [
            ...
            [ 'question' => 'هل السيو أجدى من الإعلانات المدفوعة في مصر؟', 'answer' => 'ليسا بديلَين — لكنهما يعملان بمنطق مختلف. الإعلانات تُولّد زيارات فورية تتوقف بانتهاء الميزانية. السيو يبني حضوراً عضوياً يتراكم بمرور الوقت ولا يرتبط مباشرة بالإنفاق الإعلاني. المزيج بين الاثنين ممكن، وتحديد الأولوية يعتمد على أهداف العمل والميزانية المتاحة.' ],
    ...
    'saudi-arabia' => [
        ...
        'points'       => [
            ...
            [ 'label' => 'تراكم سلطة الموقع',              'desc' => 'الحضور العضوي يتراكم بمرور الوقت — وتحليل الكلمات والمنافسة يُحدد القطاعات وأنواع الصفحات ذات الأولوية وفقاً لبيانات البحث الفعلية' ],
        ...
        'why_items'    => [
            ...
            [ 'label' => 'تقارير ترتبط بمؤشرات عملك',     'desc' => 'بيانات البحث العضوي والصفحات — مع إمكانية ربط التحويلات عند توافر إعداد تتبع موثوق' ],
        ...
        'scope_desc'   => 'كل خدمة في القائمة أدناه مبنية على فهم حقيقي لمتطلبات السوق السعودي — من تحليل الكلمات وبنية البحث في كل قطاع، إلى متطلبات منصات التجارة الإلكترونية المحلية، وصولاً لتقارير مرتبطة بمؤشرات الأداء الفعلية.',
        'scope_items'  => [
            ...
            [ 'n' => '05', 'label' => 'بناء الروابط الخارجية',               'desc' => 'روابط من مصادر محلية وعالمية موثوقة تبني سلطة الموقع وتُعزز ظهوره في نتائج البحث' ],
            ...
            [ 'n' => '09', 'label' => 'السيو المحلي وخرائط جوجل',           'desc' => 'يُحدد التدقيق ما إذا كان النشاط يحتاج استهدافاً وطنياً أو محلياً. بالنسبة للمواقع المؤهلة، قد يشمل العمل تحسين الملف التجاري على Google في مدن كالرياض وجدة والدمام والخبر، واتساق معلومات النشاط والمراجعات. صفحات المدن تُنشأ فقط عند وجود قيمة محلية فعلية.' ],
        ],
        'process_tag'   => 'منهجية العمل',
        ...
        'process_steps' => [
            ...
            [ 'n' => '04', 'title' => 'المحتوى والروابط شهراً بعد شهر',    'desc' => 'محتوى مُنشأ باستمرار لاستهداف الكلمات الجديدة، وروابط خارجية مدروسة — العمل يتراكم شهرياً ويُقيَّم بالبيانات.' ],
        ...
        'faqs'         => [
            ...
            [ 'question' => 'هل تشمل الخدمة السيو المحلي لمدن مثل الرياض وجدة والدمام؟', 'answer' => 'يُحدد التدقيق ما إذا كان النشاط يحتاج استهدافاً وطنياً أو محلياً. بالنسبة للمواقع المؤهلة، قد يشمل العمل تحسين الملف التجاري على Google، واتساق معلومات النشاط، وإشارات الفروع أو نطاق الخدمة والمراجعات. ولا تُنشأ صفحات المدن إلا عندما يخدم النشاط المدينة فعلياً ويقدم فيها قيمة محلية واضحة.' ],
    ...
    'uae' => [
        ...
        'why_items'    => [
            ...
            [ 'label' => 'تقارير مرتبطة بمؤشرات عملك',       'desc' => 'بيانات البحث العضوي والصفحات — مع إمكانية ربط التحويلات عند توافر إعداد تتبع موثوق' ],
        ...
        'scope_desc'   => 'سيو عربي قوي لجمهورك المحلي، وسيو إنجليزي للجمهور الدولي عند الاقتضاء — مع بنية متعددة اللغات ووسوم hreflang تساعد Google على فهم اللغة والمنطقة المستهدفة وتقليل تعارض الإشارات بين النسخ.',
        'scope_items'  => [
            ...
            [ 'n' => '05', 'label' => 'بناء الروابط إقليمياً ودولياً',   'desc' => 'روابط من مصادر إقليمية ودولية موثوقة تُعزز سلطة الموقع وتُحسّن ظهوره في نتائج البحث' ],
            ...
            [ 'n' => '09', 'label' => 'السيو المحلي وخرائط جوجل',       'desc' => 'يُحدد التدقيق ما إذا كان النشاط يحتاج استهدافاً وطنياً أو محلياً. بالنسبة للمواقع المؤهلة، قد يشمل العمل تحسين الملف التجاري على Google في مدن كدبي وأبوظبي والشارقة، واتساق معلومات النشاط والمراجعات. صفحات المدن تُنشأ فقط عند وجود قيمة محلية فعلية.' ],
        ],
        'process_tag'   => 'منهجية العمل',
        ...
        'process_steps' => [
            ...
            [ 'n' => '04', 'title' => 'المحتوى والروابط',                   'desc' => 'محتوى عميق يُعالج أسئلة الجمهور المستهدف، وروابط مدروسة من مصادر موثوقة — يبنيان سلطة الموقع بصورة تتراكم شهرياً.' ],
        ...
        'faqs'         => [
            ...
            [ 'question' => 'كيف تتعاملون مع الأسواق التي تضم مواقع دولية؟', 'answer' => 'الأسواق التي تضم مواقع دولية تستهدف الكلمات ذاتها تتطلب سيو تقنياً قوياً ومحتوى عالي الجودة. نُحلّل المنافسين في قطاعك ونضع استراتيجية تأخذ في الحسبان طبيعة المنافسة. الروابط الخارجية من مصادر موثوقة تُعزز سلطة الموقع وتُحسّن موقعه في نتائج البحث.' ],
            [ 'question' => 'هل تشمل الخدمة السيو المحلي لمدن دبي وأبوظبي والشارقة؟', 'answer' => 'يُحدد التدقيق ما إذا كان النشاط يحتاج استهدافاً وطنياً أو محلياً. بالنسبة للمواقع المؤهلة، قد يشمل العمل تحسين الملف التجاري على Google، واتساق معلومات النشاط، وإشارات الفروع أو نطاق الخدمة والمراجعات. ولا تُنشأ صفحات المدن إلا عندما يخدم النشاط المدينة فعلياً ويقدم فيها قيمة محلية واضحة.' ],
            [ 'question' => 'كيف تعملون مع المواقع ثنائية اللغة؟',          'answer' => 'نُعدّ استراتيجية منفصلة لكل لغة — كلمات مفتاحية ومحتوى وروابط لكل نسخة — مع إعداد hreflang بشكل صحيح لكل صفحة حتى يُدرك جوجل اللغة والمنطقة المستهدفة لكل نسخة ويُقدّم الصفحة الصحيحة للجمهور الصحيح.' ],
...
$results_url  = sh_safe_url( 'results' );
...
$trust_items = [
    ...
    'إلمام بالأسواق العربية والمتطلبات المحلية',

...
$country_config = [
    ...
    'egypt' => [
        ...
        'hero_desc'    => 'مصر سوق رقمي في طور النضج — الطلب على البحث في ارتفاع مستمر. من يستثمر في السيو اليوم يبني ميزة تنافسية يصعب اللحاق بها لاحقاً.',
        ...
        'why_items'    => [
            ...
            [ 'label' => 'تقارير مرتبطة بأهداف عملك',       'desc' => 'العملاء المحتملون والمبيعات الفعلية — لا مجرد أرقام ترافيك عامة' ],
        ...
        'scope_desc'   => 'كل خدمة في هذه القائمة مُصمَّمة للعمل في السياق المصري — الكلمات التي يستخدمها جمهورك، المنافسون الذين يجب فهمهم وتجاوزهم، والمحتوى الذي يُقنع المستخدم المصري ويُحوّله لعميل. التسلسل من الأساسيات إلى الروابط ليس عشوائياً — هو الترتيب الذي يحقق نتائج مستدامة.',
        'scope_items'  => [
            ...
            [ 'n' => '08', 'label' => 'تقارير الأداء الشهرية',    'desc' => 'تقرير يربط حركة البحث بالعملاء المحتملين والمبيعات ومؤشرات العائد التجاري' ],
            [ 'n' => '09', 'label' => 'السيو المحلي وخرائط جوجل', 'desc' => 'تحسين الظهور المحلي في القاهرة والجيزة والإسكندرية — ملف جوجل بيزنس وصفحات المدن والإشارات المحلية' ],
        ],
        ...
        'faqs'         => [
            [ 'question' => 'هل تعملون مع شركات ومتاجر في مصر؟',           'answer' => 'نعم. نعمل مع شركات ومتاجر في السوق المصري — نفهم طبيعة البحث المصري ونستهدف الكلمات التي يستخدمها المستخدم المصري فعلاً. التحليل والتنفيذ والتقارير يصلك كاملاً عن بُعد، والتواصل المباشر مع الفريق متاح في أي وقت.' ],
            ...
            [ 'question' => 'كيف تختلف استراتيجية السيو للسوق المصري؟',     'answer' => 'تختلف المنافسة قطاعاً بقطاع. التجارة الإلكترونية والصحة منافسة عالية في المدن الكبرى، لكن خارج القاهرة والإسكندرية ثمة فرص سهلة الاختراق نُحدّدها في مرحلة التدقيق. كذلك طريقة البحث تتفاوت — الفصحى لقطاعات كالتعليم والصحة، والعامية أكثر شيوعاً في الخدمات اليومية والأغذية والترفيه. الاستراتيجية تُراعي هذا التفاوت من البداية.' ],
            [ 'question' => 'هل تعملون عن بُعد مع العملاء المصريين؟',       'answer' => 'نعم تماماً. نعمل بالكامل عن بُعد مع لقاءات متابعة دورية وتقارير منتظمة — بغض النظر عن موقع العميل.' ],
            ...
            [ 'question' => 'ما الذي يشمله التقرير الشهري؟',               'answer' => 'البيانات متاحة في لوحة Looker Studio حية متصلة بـSearch Console وGoogle Analytics. التقرير يشمل: ترتيب الكلمات المستهدفة وتطوره، حركة البحث العضوي، العملاء المحتملين من البحث عند تفعيل التتبع، ملخص العمل المُنجز، والخطة المقترحة للشهر التالي — بلغة مباشرة لا تقنية مبهمة.' ],
        ],
    ...
    'saudi-arabia' => [
        ...
        'points'       => [
            [ 'label' => 'انتشار رقمي واسع',              'desc' => 'معدلات استخدام الإنترنت والهواتف الذكية في السعودية من الأعلى إقليمياً — قاعدة بحث واسعة لمن يستهدفها' ],
        ...
        'why_items'    => [
            ...
            [ 'label' => 'تقارير ترتبط بمؤشرات عملك',     'desc' => 'عملاء محتملون ومبيعات وCAC — لا أرقام ترافيك معلقة في الهواء' ],
        ...
        'scope_desc'   => 'كل خدمة في القائمة أدناه مبنية على فهم حقيقي لمتطلبات السوق السعودي — من أنماط البحث التجاري العالي القيمة التي تميّز المستخدم السعودي، إلى متطلبات منصات التجارة الإلكترونية المحلية، وصولاً لتقارير ترتبط بمؤشرات العائد التجاري الفعلي.',
        'scope_items'  => [
            ...
            [ 'n' => '08', 'label' => 'تقارير الأداء والعائد',               'desc' => 'تقرير يُظهر كيف تتحول حركة البحث إلى عملاء محتملين ومبيعات — متاح عبر Looker Studio في أي وقت' ],
            [ 'n' => '09', 'label' => 'السيو المحلي وخرائط جوجل',           'desc' => 'تحسين الظهور المحلي في الرياض وجدة والدمام — ملف جوجل بيزنس وصفحات المدن وإشارات الحضور المحلي' ],
        ],
        'process_tag'   => 'منهجية العمل',
        ...
        'proof_desc'   => 'اطّلع على نماذج من نتائج أعمالنا والمنهج المستخدم في تنفيذ مشروعات السيو.',
        'faqs'         => [
            [ 'question' => 'هل أنتم شركة سيو تخدم السعودية؟',               'answer' => 'نعم. سيو هاوس تخدم السوق السعودي — نفهم طبيعة البحث السعودي والكلمات التي يستخدمها العميل في قطاعك تحديداً، ونعمل عن بُعد مع الفريق الكامل متاح للتواصل.' ],
            [ 'question' => 'كيف يختلف السيو في السعودية عن باقي الدول؟',     'answer' => 'المنافسة في السعودية أعلى في قطاعات كالعقارات والتجزئة والصحة. نُحلّل المنافسين محلياً ونبني استراتيجية تأخذ في الحسبان كثافة الكلمات في كل منطقة. اختلاف آخر مهم: الجمهور السعودي يميل للبحث بنية شراء مباشرة — مما يعني أن الكلمات ذات الأولوية غالباً تجارية وليست استفسارية فقط.' ],
            [ 'question' => 'هل تعملون مع متاجر سلة وزد وShopify في السعودية؟', 'answer' => 'نعم. سيو منصات التجارة الإلكترونية يتطلب معرفة تقنية بطريقة عمل كل منصة — سلة وزد وShopify وWooCommerce لكل منها متطلبات مختلفة في بنية الصفحات والفهرسة والربط الداخلي. نُعدّ الاستراتيجية وفق المنصة المستخدمة.' ],
            [ 'question' => 'ما العائد المتوقع من السيو في السعودية؟',          'answer' => 'يختلف بحسب القطاع والمنافسة وحالة الموقع. بشكل عام، العملاء الذين يستمرون 6 أشهر أو أكثر يرون نمواً تدريجياً في العملاء المحتملين من البحث العضوي — تحليل الوضع الأولي يُعطي صورة أوضح عما يمكن توقعه في قطاعك.' ],
            ...
            [ 'question' => 'هل السيو مناسب للشركات الصغيرة في السعودية؟',    'answer' => 'نعم — بل هو أكثر ما يُفيد الشركات الصغيرة والمتوسطة. بدلاً من المنافسة في الإعلانات المدفوعة مع ميزانيات ضخمة، تبني حضوراً عضوياً يُعطيك ترافيكاً متراكماً بتكلفة أقل على المدى البعيد. الميزانية المحدودة ليست عائقاً — السيو يمكن تطبيقه بشكل مُرحَّل، يبدأ بالأساسيات والكلمات الأكثر أهمية ثم يتوسع بحسب النتائج والموارد المتاحة.' ],
    ...
    'uae' => [
        ...
        'points'       => [
            ...
            [ 'label' => 'قطاع العقارات والسياحة',         'desc' => 'من أبرز القطاعات في البحث الرقمي بالإمارات — يستحق استراتيجية سيو متخصصة' ],
            [ 'label' => 'جمهور رقمي نشط',                 'desc' => 'معدلات استخدام الإنترنت والهواتف الذكية في الإمارات من الأعلى إقليمياً — بيئة بحث نشطة لمن يستهدفها جيداً' ],
        ],
        'why_tag'      => 'استراتيجية محلية',
        ...
        'why_items'    => [
            ...
            [ 'label' => 'تقارير مرتبطة بمؤشرات عملك',       'desc' => 'عملاء محتملون ومبيعات وCAC — لا مجرد أرقام زيارات لا تُترجَم إلى نتائج تجارية' ],
        ...
        'scope_items'  => [
            ...
            [ 'n' => '06', 'label' => 'سيو العقارات والسياحة',           'desc' => 'تحسين متخصص لقطاعات العقارات والسياحة والضيافة — قطاعات بارزة في البحث الرقمي بالإمارات' ],
            [ 'n' => '07', 'label' => 'التحسين المستمر والتكيف',         'desc' => 'رصد تغيرات المنافسة الدولية وتعديل الاستراتيجية بانتظام للحفاظ على موقعك' ],
            [ 'n' => '08', 'label' => 'تقارير ثنائية اللغة',             'desc' => 'لوحة Looker Studio تُظهر الأداء بالعربية والإنجليزية وترتبط بمؤشراتك التجارية الفعلية' ],
            [ 'n' => '09', 'label' => 'السيو المحلي وخرائط جوجل',       'desc' => 'تحسين الظهور المحلي في دبي وأبوظبي والشارقة — ملف جوجل بيزنس وصفحات المدن والإشارات المحلية' ],
        ],
        'process_tag'   => 'منهجية العمل',
        ...
        'proof_desc'   => 'اطّلع على نماذج من نتائج أعمالنا والمنهج المستخدم في تنفيذ مشروعات السيو.',
        'faqs'         => [
            [ 'question' => 'هل تعملون مع شركات في دبي وأبوظبي؟',           'answer' => 'نعم. نعمل مع شركات في السوق الإماراتي — نفهم التنوع السوقي في الإمارات والفرق بين استهداف جمهور عربي وجمهور دولي. التواصل كله عن بُعد ولا يؤثر على جودة الخدمة — التحليل والاستراتيجية والتنفيذ والتقارير تُنجز بنفس المستوى.' ],
            ...
            [ 'question' => 'ما القطاعات التي تعملون بها في الإمارات؟',      'answer' => 'نعمل في قطاعات العقارات والسياحة والضيافة والتجارة الإلكترونية والتعليم والتقنية في الإمارات — قطاعات ذات حضور واسع في نتائج جوجل في هذا السوق. كل قطاع يتطلب مقاربة مختلفة — العقارات تحتاج صفحات محلية وسيو خرائط، السياحة تحتاج محتوى معلوماتياً غنياً، والتجارة الإلكترونية تحتاج تحسين بنية الكتالوج وصفحات المنتجات.' ],
            [ 'question' => 'كيف تتعاملون مع المنافسة الدولية؟',             'answer' => 'المنافسة الدولية تتطلب سيو أعمق — تقنياً ومحتوى وروابط. نُحلّل المنافسين الدوليين في قطاعك ونضع استراتيجية تُمكّنك من المنافسة الفعلية لا مجرد الظهور في الصفحة الثالثة. الروابط الخارجية الدولية تلعب دوراً حاسماً هنا — المواقع التي تحصل على إشارات من مصادر موثوقة في الفضاء العالمي تُقاوم المنافسة الدولية بشكل أفضل بكثير.' ],
            [ 'question' => 'هل تشمل الخدمة السيو المحلي لمدن دبي وأبوظبي والشارقة؟', 'answer' => 'نعم. السيو المحلي في الإمارات يشمل تحسين ملف جوجل بيزنس لكل موقع وصفحات الخدمة الموجّهة جغرافياً وإشارات الحضور المحلي — الفرق بين دبي وأبوظبي والشارقة يُؤخذ بعين الاعتبار في تخصيص الصفحات والكلمات.' ],
            ...
            [ 'question' => 'هل يمكنني تتبع عائد الاستثمار من السيو؟',       'answer' => 'نعم. نربط السيو بـ Google Analytics وSearch Console ونُعدّ تتبع التحويلات — عملاء محتملون ومبيعات وCAC — حتى يكون القرار مبنياً على بيانات حقيقية لا تقديرات.' ],
        ],
...
$report_checklist = [
    ...
    'عدد العملاء المحتملين والتحويلات من البحث — عند تفعيل التتبع',

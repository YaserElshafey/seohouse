...
$country_config = [
    ...
    'egypt' => [
        ...
        'faqs'         => [
            [ 'question' => 'هل تعملون مع شركات ومتاجر في مصر؟',           'answer' => 'نعم. نخدم عملاء في مصر بشكل منتظم — شركات خدمية ومتاجر إلكترونية ومؤسسات تعليمية. نفهم طبيعة البحث المصري ونستهدف الكلمات التي يستخدمها المستخدم المصري فعلاً. نعمل مع شركات في القاهرة والإسكندرية والمدن الأخرى عن بُعد — التحليل والتنفيذ والتقارير يصلك كاملاً، والتواصل المباشر مع الفريق متاح في أي وقت.' ],
            ...
            [ 'question' => 'متى أبدأ برؤية نتائج في السوق المصري؟',        'answer' => 'المؤشرات الأولى تظهر بين الشهر الثاني والثالث. النتائج الواضحة في الترافيك والليدز تتراكم بين الشهر الرابع والسادس. السيو في مصر — كأي سوق آخر — يحتاج صبراً وعمل متراكم. المواقع التي تبدأ بأسس تقنية سليمة تصل للنتائج أسرع — التدقيق الأولي يكشف إذا كانت ثمة عوائق تُبطئ الأمور حتى قبل البدء بالاستراتيجية.' ],
            ...
            [ 'question' => 'هل السيو أجدى من الإعلانات المدفوعة في مصر؟', 'answer' => 'ليسا بديلَين — لكنهما بمنطق مختلف. الإعلانات تُولّد ترافيكاً فورياً ينتهي بانتهاء الميزانية. السيو يبني ترافيكاً متراكماً مستداماً. الشركات الذكية تُشغّل الاثنين: الإعلانات قصيرة المدى والسيو استثمار طويل. في السوق المصري تحديداً، تكلفة النقرة المدفوعة في ارتفاع — مما يجعل السيو خياراً استراتيجياً أكثر استدامة على المدى البعيد لمن يصبر عليه.' ],
            [ 'question' => 'ما الذي يشمله التقرير الشهري؟',               'answer' => 'التقرير يشمل: ترتيب الكلمات المستهدفة وتطوره، حركة البحث العضوي، عدد الليدز من البحث، ملخص العمل المُنجز، والخطة المقترحة للشهر التالي — بلغة مباشرة لا تقنية مبهمة. التقرير يُرسَل بصيغة PDF قابلة للمشاركة، مع جلسة مراجعة شهرية يشرح فيها مدير الحساب الأرقام والتوجهات وأي تعديلات مقترحة على الخطة.' ],
        ],
    ...
    'saudi-arabia' => [
        ...
        'scope_items'  => [
            ...
            [ 'n' => '06', 'label' => 'سيو سلة وزد والمتاجر السعودية',      'desc' => 'تحسين صفحات المنتجات والفئات في منصات التجارة الإلكترونية المستخدمة في السوق السعودي' ],
        ...
        'faqs'         => [
            ...
            [ 'question' => 'كيف يختلف السيو في السعودية عن باقي الدول؟',     'answer' => 'المنافسة في السعودية أعلى في قطاعات كالعقارات والتجزئة والصحة — لكن قيمة الليد أعلى أيضاً. نُحلّل المنافسين محلياً ونبني استراتيجية تأخذ في الحسبان كثافة الكلمات في كل منطقة. اختلاف آخر مهم: الجمهور السعودي يميل للبحث بنية شراء مباشرة — مما يعني أن الكلمات ذات الأولوية غالباً تجارية وليست استفسارية فقط.' ],
            [ 'question' => 'هل تعملون مع متاجر سلة وزد في السعودية؟',        'answer' => 'نعم. سيو سلة وزد يتطلب معرفة تقنية بطريقة عمل كل منصة — من بنية الصفحات وعناوين المنتجات إلى الفهرسة والربط الداخلي. نقدم تحسينات موجّهة لهذه المنصتين ونُعدّ الاستراتيجية وفق متطلبات كل منهما.' ],
            [ 'question' => 'ما العائد المتوقع من السيو في السعودية؟',          'answer' => 'يختلف بحسب القطاع والمنافسة. بشكل عام، العملاء الذين يستمرون 6 أشهر أو أكثر يرون نمواً تدريجياً في الليدز العضوية مع انخفاض في الاعتماد على الإعلانات المدفوعة. قطاعات كالعقارات وعيادات الأسنان والتجزئة المتخصصة تشهد عادةً عائداً أسرع — لأن حجم البحث فيها مرتفع والمنافسة لا تزال قابلة للاختراق بالاستراتيجية الصحيحة.' ],
    ...
    'uae' => [
        ...
        'faqs'         => [
            [ 'question' => 'هل تعملون مع شركات في دبي وأبوظبي؟',           'answer' => 'نعم. نخدم عملاء في الإمارات بانتظام — في دبي وأبوظبي والشارقة. نفهم التنوع السوقي في الإمارات والفرق بين استهداف جمهور عربي وجمهور دولي. التواصل كله عن بُعد ولا يؤثر على جودة الخدمة — التحليل والاستراتيجية والتنفيذ والتقارير تُنجز بنفس المستوى بغض النظر عن المسافة.' ],
            ...
            [ 'question' => 'ما القطاعات التي تعملون بها في الإمارات؟',      'answer' => 'لدينا خبرة في العقارات والسياحة والضيافة والتجارة الإلكترونية والتعليم والتقنية في الإمارات — وهي قطاعات ذات حضور واسع في نتائج جوجل في هذا السوق. كل قطاع يتطلب مقاربة مختلفة — العقارات تحتاج صفحات محلية وسيو خرائط، السياحة تحتاج محتوى معلوماتياً غنياً، والتجارة الإلكترونية تحتاج تحسين بنية الكتالوج وصفحات المنتجات.' ],
            ...
            [ 'question' => 'متى نرى نتائج ملموسة في السوق الإماراتي؟',      'answer' => 'في سوق تنافسي كالإمارات، المؤشرات الأولى تظهر بين الشهر الثاني والثالث، والتأثير الحقيقي على الليدز يتراكم من الشهر الرابع فصاعداً — كلما كانت الأساسيات التقنية سليمة تسارعت النتائج. الشفافية في التوقعات أساسية — لا نعد بنتائج في الشهر الأول، لكننا نضع معك مؤشرات مرحلية واضحة من البداية حتى تعرف أين تسير الأمور في كل وقت.' ],
...
<section class="sec sec-off">
  <div class="wrap">
    ...
    <div class="ind-grid sr d1" style="margin-top:32px">
      ...
      <a href="<?php echo esc_url( $results_url ); ?>" class="ind-card">

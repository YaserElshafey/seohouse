...
add_action( 'acf/init', function () {
    ...
    acf_add_local_field_group( [
        ...
        'fields'   => [
            ...
            [
                ...
                'label'        => 'شورت كود المراجعات',
                'name'         => 'reviews_shortcode',
                'type'         => 'textarea',
                'rows'         => 2,
                'placeholder'  => '[trustindex no-script]',
                'instructions' => 'ألصق شورت كود بلغين المراجعات هنا (Trustindex أو غيره). إذا كان الحقل فارغاً، لن يظهر القسم.',
            ],
    ...
    acf_add_local_field_group( [
        ...
        'fields'   => [
            ...
            // ── Tab 1: بيانات البطاقة ─────────────────────────
            // Fields used on homepage preview cards and Results archive cards
            [
            ...
            [
                'key'           => 'field_cs_show_on_homepage',
                'label'         => 'ظاهر في الصفحة الرئيسية؟',
                'name'          => 'show_on_homepage',
                'type'          => 'true_false',
                'default_value' => 0,
                'instructions'  => 'فعّل هذا الخيار لتظهر البطاقة ضمن مقتطفات النتائج في الرئيسية.',
            ],
            [
                'key'          => 'field_cs_client_name',
                'label'        => 'اسم المشروع / العميل',
                'name'         => 'client_name',
                'type'         => 'text',
            ...
            [
                ...
                'type'         => 'text',
                'placeholder'  => 'مثال: +312% أو ×3 مبيعات أو 14 كلمة في الصفحة الأولى',
                'instructions' => 'الرقم أو العبارة البارزة — تظهر كرقم أخضر كبير في بطاقة الرئيسية وصفحة النتائج وصفحة التفاصيل.',
            ],
            [
                'key'          => 'field_cs_card_meta',
                'label'        => 'نص المؤشر المرافق',
                'name'         => 'card_meta',
                'type'         => 'text',
                'placeholder'  => 'مثال: 8 أشهر تعاون مستمر',
                'instructions' => 'يظهر أسفل الرقم البارز في البطاقة — يمكن أن يكون المدة أو ملاحظة مختصرة.',
            ],

            // ── Tab 2: تفاصيل الصفحة الداخلية ──────────────────
            // Fields used only on the single case study page
            [
                'key'       => 'field_cs_tab_detail',
                'label'     => 'تفاصيل الصفحة الداخلية',
                'name'      => '',
                'type'      => 'tab',
                'placement' => 'top',
            ],
            [
                ...
                'type'         => 'textarea',
                'rows'         => 4,
                'instructions' => 'ما كان الوضع قبل التدخل؟ ما المشكلة التي واجهها العميل؟',
            ],
            [
                'key'          => 'field_cs_solution',
                'label'        => 'الحل المُنفَّذ',
                'name'         => 'solution',
                'type'         => 'textarea',
                'rows'         => 4,
                'instructions' => 'ما الذي نفّذناه تحديداً لمعالجة هذه المشكلة؟',
            ],
            [
                'key'          => 'field_cs_result',
                ...
                'type'         => 'textarea',
                'rows'         => 4,
                'instructions' => 'وصف تفصيلي للنتائج المحققة.',
            ],
            [
                'key'          => 'field_cs_metrics',
                'label'        => 'مؤشرات الأداء التفصيلية',
                'name'         => 'metrics',
                'type'         => 'repeater',
                'max'          => 6,
                'button_label' => 'إضافة مؤشر',
                'instructions' => 'أرقام وإنجازات قابلة للقياس — تظهر في شبكة المؤشرات بصفحة التفاصيل.',
                'sub_fields'   => [
                    [ 'key' => 'field_metric_label', 'label' => 'التسمية', 'name' => 'label', 'type' => 'text', 'placeholder' => 'مثال: نمو الزيارات العضوية' ],
                    [ 'key' => 'field_metric_value', 'label' => 'القيمة',  'name' => 'value', 'type' => 'text', 'placeholder' => 'مثال: +245%' ],
                ],
            ],

            // ── Tab 3: الميديا والروابط ──────────────────────────
            [
                'key'       => 'field_cs_tab_media',
                'label'     => 'الميديا والروابط',
                'name'      => '',
                'type'      => 'tab',
                'placement' => 'top',
            ],
            ...
            [
                ...
                'label'         => 'لقطات شاشة المشروع',
                'name'          => 'gallery',
                'type'          => 'gallery',
                'return_format' => 'array',
                'instructions'  => 'لقطات شاشة من Search Console وAnalytics وAhrefs وSEMrush وغيرها — تظهر في صفحة التفاصيل فقط.',
            ],
            [
                'key'          => 'field_cs_cta_url',
                'label'        => 'رابط خاص (اختياري)',
                'name'         => 'cta_url',
                'type'         => 'url',
                'instructions' => 'اتركه فارغاً لاستخدام صفحة الاتصال الافتراضية في زر CTA.',
            ],
        ],
    ] );
    ...
    acf_add_local_field_group( [
        ...
        'fields'   => [
            ...
            [
                'key'          => 'field_con_calendly_embed',
                'label'        => 'كود Calendly للحجز (Inline Embed)',
                'name'         => 'calendly_embed',
                'type'         => 'textarea',
                'rows'         => 5,
                'placeholder'  => '<div class="calendly-inline-widget" data-url="https://calendly.com/username/30min" style="min-width:320px;height:700px;"></div>' . "\n" . '<script type="text/javascript" src="https://assets.calendly.com/assets/external/widget.js" async></script>',
                'instructions' => 'الصق كود Calendly الكامل (Inline Widget) هنا كما هو من موقع Calendly. إذا كان الحقل فارغاً، لن تظهر بطاقة الحجز.',
            ],
